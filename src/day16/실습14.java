...
public class 실습14 {
    public static void main(String[] args) {
        // [1] ArithmeticException : 나누기 0 을 하면 발생하는 에러

        try{  int result = 10 / 0; } //예외발생이유 : by zero , 0으로 나누기 불가능
        catch ( ArithmeticException e ) {
            System.out.println(  "0으로 나눌 수 없습니다." + e );
        }

        // [2] NumberFormatException : 숫자 형식 오류
        try{
        ...
        }catch ( ArrayIndexOutOfBoundsException e ){ System.out.println("잘못된 인덱스에 접근했습니다."); }
