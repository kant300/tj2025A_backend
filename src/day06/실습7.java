...
public class 실습7 {
    public static void main(String[] args) {
        ...
        Book b1 = new Book();   // (2) 객체 생성한다. , new 클래스명();
        ...
        Pet p1 = new Pet(); //(2) 객체를 생성한다.
        Pet p2 = new Pet(); // 클래스명 변수명 = new 클래스명();
        p1.name = "초코"; p1.species = "푸들"; p1.age = 3; //(3) 첫 번째 객체에는 "초코", "푸들", 3을
        p2.name = "나비"; p2.species = "코리안숏헤어"; p2.age = 5; // (3) 두 번째 객체에는 "나비", "코리안숏헤어", 5를 각각 저장
        // (4) "이름: [이름], 종류: [품종], 나이: [나이]살" 형식으로 출력
        ...
        prod1.name = "새우깡"; prod1.price = 1500; //각각 "새우깡", 1500과 "콜라", 2000 정보를 저장하세요.
