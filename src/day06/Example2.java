...
public class Example2 {
    public static void main(String[] args) {
        ...
        [ 클래스와 객체 ]
            ...
            2) 객체 종류 : 모든 것들 , 속성과 기능을 정의한다면 가능
                사람(물리) , 주문(논리) , 안경(물리) , 공기(물리) , 강의(논리) 등등
            3) 객체지향 프로그래밍 : 개발자(주체)가 컴퓨터안에서 객체(대상) 만들기
            4) 클래스 : 객체를 만들기 위한 설계도, 속성가 기능 코드로 표현
                - 속성 : 대상의 본질적인 특징/성질/특성    -> 멤버변수
                - 기능 : 대상의 작동/행위/이벤트          -> 멤버함수, 메소드
            * 자바는 모든 코드의 컴파일은 클래스 단위로 컴파일 한다. *
            5) 생활속 예시
                (1) 학생 객체 만들기
                1. 클래스를 정의한다. 즉] 속성과 기능을 정의/만들기 -> 특징, 이벤트 만들기
                    -> 학생에게 속성 부여 : 이름 , 학번 , 전화번호
            ...
            6) 사용법
                ...
                < 객체내 멤버변수 값 수정 >
                    변수명.멤버변수 = 새로운값
                < 객체 내 멤버변수 추가 / 삭제 불가능 >
                    - 자바는 실행도중에 클래스 정보를 수정할 수 없다. 단점] 유연성이 떨어진다.
        ...
        // [2] 학생 클래스 이용한 학생 객체 만들기 : 자바는 객체를 만들기 위해서 *무조건*클래스가 필요하다.
            // 2. 객체 만들기                : new 클래스명();
        new Student();  //객체생성
        // [3] 주로 생성된 객체는 변수에 대입/저장한다. 타입변수명 = 값 ;  , 타입 변수명 = 객체;
            // * 객체를 저장하는 변수의 타입은 객체의 클래스/타입 로 선언한다.
        Student s1 = new Student();
        // [4] 생성된 객체 정보 호출
        System.out.println( s1 );   // day06.Student@119d7047 : 객체의 주소(컴퓨터내 메모리 위치공간)값이 반환된다.
        // [5] 객체내 멤버변수 호출
        ...
        // [8] 붕어빵 객체 만들기
            ...
            // - 붕어빵 장사를 하기전에 붕어빵 주인은 붕어빵틀(기계) 구입한다.
        ...
        빵3.가격 = 1500; // --- 슈크림 붕어빵 객체 생성
            ...
            // 3) 객체와 배열의 관계 : 배열은 동일한 타입/클래스 데이터/객체를 여러
                // - 주문한 붕어빵 3개를 비닐봉지에 넣어주세요.
        붕어빵틀[] 빵봉지 = { 빵1 , 빵2 , 빵3 };
            // * 서로 다른 속성/타입들은 데이터들은 묶음 --> 객체 , 내용물/가격 --> 객체
            // * 서로 같은 속성/타입들은 데이터들은 묶음 --> 배열 , 빵1빵2빵3 --> 배열
