        ...
        [ 메소드 ] , 멤버함수 또는 메소드
            ...
            3. 용어
                ...
                2). 매개변수 : 메소드 실행시 메소드 안으로 들어오는 값을 저장하는 변수
                    (1). 매개변수 없을 수도 있다.
                    (2). ***인수값의 타입과 매개변수의 타입이 일치 해야 한다. *** 타입이 상속되야 한다.다형성
                    (3). 지역변수 - 함수안에서만 실행되고 사라진다.
            ...
            4. 메소드 호출하는 방법 ;
                [방법1] 호출하고자 하는 메소드가 다른 클래스일때 -> 객체가 필요
                    1) 클래스 변수명 = new 클래스명();
                    2) 변수명.메소드명();
         */
...
// [5] 매개변수 O , 반환값 X
cal1.printSum( 3 , 5 ); // 2개의 정수 인수값 x:3 ,  y:3
