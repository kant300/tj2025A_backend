...
public class Example3 {
    public static void main(String[] args) {
        ...
        [ 인터페이스 ] :
            ...
            2. 생활속 예]
                키보드 : 키우기게임(A:식량주기) , 축구(A:슈팅) 등 서로 다른 게임/프로그램들을 하나의 키보드로 조작
                키오스크 : 국밥키오스크, 아이스크림키오스크 등 서로 다른 업체들을 하나의 키오스크로 조작
                TV 리모콘 : 서로 다른 회사/모델의 TV들을 하나의 리모콘 조작
            ...
            5. 선언하는 방법
                ...
                2) 하위에 (인터페이스)선택 -> 인터페이스명 정하기(첫글자 대문자)
                - interface 인터페이스명{ }
            6. 인터페이스 타입의 멤버
                1) 상수
                    public static final
            ...
            7. 상속         vs     구현(인터페이스)
             ...
             extends            implements
             객체생성             객체생성불가능(생성자없어서)
             하나의상위클래스       여러개의 인터페이스 구현
             오버라이딩(선택)       오버라이딩(구현) 팔수
