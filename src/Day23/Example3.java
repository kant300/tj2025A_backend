...
public class Example3 {
    public static void main(String[] args) {
        ...
        Map 인터페이스 : 순서(인덱스) 없이 key와 value를 한쌍(entry)으로 여러 쌍을 저장하는 구조
            -> HTML/CSS/JS <---> JSON
         ...
         */
        // [1] HashMap 객체생성 , < key타입 , value타입 >
        Map< String , Integer > map = new HashMap<>();
        // [2] 주요 메소드
            // 1) .put( key자료1 , value자료2 ): MAP객체내 KEY와 VALUE 자료를 한쌍(ENTRY)을 저장한다.
        map.put( "유재석" , 95 ); // "유재석"자료는 key(속성명) , 95자료는  value(속성값)
        map.put( "강호동" , 100 ); // "강호동"속성명(key)에 100 대입/저장한다.
        map.put( "신동엽" , 78 );
        ...
        // DTO는 미리 멤버변수 정의/설계 N회성 객체 , MAP은 1회성 객체

        // [4] 구현체
        // Map 인터페이스 : key와 value 를 (자료2개)를 한쌍(entry자료1개)으로 여러개 쌍을 저장
