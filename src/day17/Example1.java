...
public class Example1 {
    public static void main(String[] args) {
        ...
        // OpenCSV 라이브러리 : 목적 : CSV 규칙에 따르,ㄴ 자동 분해/분리
        // 각종 자바 관련 라이브러리 공유  : https://mvnrepository.com/
        // (1) OpenCSV : https://mvnrepository.com/artifact/net.sf.opencsv/opencsv/2.3 (버전확인)
        // (2) [JAR] 다운로드 버튼 클릭
        // (3) 해당 패키디로 넣기
        ...
        // * OpenCSV 라이브러리 사용해보기
            ...
            //new CSVWriter( new FileWriter( 파일경로 ) ) : CSV 출력하는 클래스
                // --> .writerAll( List객체 ) : List객체를 CSV 로 내보내는 함수
        try{
            // 1. 파일 경로 지정
