...
public class 실습4 { //class s
    public static void main(String[] args) { //main s
        Scanner scan = new Scanner( System.in ); // 공통 (1) Scanner 객체 생성하여 scan변수에 저장
        // [1] 프롬프트/명령어
/*
        System.out.println("첫 번재 점수 : "); // (2) 정수 두개를 입력받아
        ...
        // [2]
        System.out.println(" 2) 정수 1 : "); int 정수1 = scan.nextInt();
        System.out.println(" 2) 정수 2 : ");
