...
public class Example1 { //class start
    public static void main(String[] args) { //main start
        ...
        float f1 = 3.14f;   double d1 = 41.14;
        int result = b1 + b2;
        int result2 = b1 + s1;
        int result3 = i1 + i1;
        long result4 = i1 + l1;  //int + logn => long
        float result5 = i1 + f1;  // int + float => flaot
