...
select title from books where stock is null;	# = null 아니라 is null 이다.
...
-- [문제 18] books 테이블에서 출판일(pub_date)이 *가장 최신*인 도서부터 *4번째에서 6번째까지의 도서 3개*의 title과 pub_date를 조회하세요. (LIMIT 오프셋 사용)
