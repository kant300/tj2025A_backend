...
public class BoardService1 {    //class s
    public static void main(String[] args) {    //main s
        ...
        // (5) for 밖에 선언 : 메모리 설계, 게시물1개당 변수2개 , 총게시물3 = 변수6개 => 자료가 많아지면 배열과 객체가 필요해짐
        ...
        for( ; ; ){ // (1)무한루프 시작   // for s
            ...
            if( choose == 1 ){
                ...
                if( content1 == null ){ // 게시물1이 비어있는지 확인
                    content1 = content; writer1 = writer;   // 입력받은 값을 대입
                    System.out.println("[글쓰기] : 성공");
                }else if( content2 == null ){   // 게시물2이 비어있는지 확인
                    content2 = content ; writer2 = writer;
                    System.out.println("[글쓰기] : 성공");
                }else if( content3 ==null ){    // 게시물3이 비어있는지 확인
