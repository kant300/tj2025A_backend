...
public class BoardDao {
    // (*)싱글톤 : 지정한 클래스내 하나의 객체를 미리 만들고 프로그램 내 하나의 객체만 존재
    private BoardDao(){
    ...
    public ArrayList<BoardDto> boardPrint() {
        // ArrayList<BoardDto> : 반환타입으로 모든 dto를 반환환다.
        return boardDB; // boardDB변수의 타입은 ArrayList<boardDto> 이다.
    } //func e
